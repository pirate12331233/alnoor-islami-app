...
enum class AppThemeMode(
    ...
    EMERALD_GREEN(
        id = "EMERALD_GREEN",
        title = "Classic Islamic Emerald",
        subtitle = "Spiritual green & radiant gold (Default)",
        primaryColorHex = 0xFF064433,
        backgroundColorHex = 0xFF071B14,
        textColorHex = 0xFFF1F5F2
    ),
    NAVY_BLUE(
        id = "NAVY_BLUE",
        title = "Dark Navy Blue",
        subtitle = "Deep navy background with crisp white text",
        primaryColorHex = 0xFF1E3A8A,
        backgroundColorHex = 0xFF0A1128,
        textColorHex = 0xFFFFFFFF
    ),
    PURE_WHITE(
        id = "PURE_WHITE",
        title = "Clean High-Contrast White",
        subtitle = "Pure white background with sharp black text",
    ...
    OLED_BLACK(
        ...
        subtitle = "True black background with high-contrast white text",
    ...
    companion object {
        fun fromId(id: String?): AppThemeMode {
            return entries.find { it.id == id } ?: EMERALD_GREEN
        }
    }
}
